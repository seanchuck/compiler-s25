                ...
                _ => {
                    ...
                    cfg.add_instruction_to_block(
                        ...
                        Instruction::CJmp {
                            name: cfg.name.clone(),
                            condition: dest,
                            id: next_true_block_id // next_false_block_id, // jump to false block if condition is FALSE
                        },
                    );
                    cfg.add_edge(
                        cur_block_id,
                    ...
                    cfg.add_instruction_to_block(
                        ...
                        Instruction::UJmp {
                            name: cfg.name.clone(),
                            id: next_false_block_id // next_true_block_id, // fall through to true block
                        },
                    );
                    cfg.add_edge(
                        cur_block_id,
